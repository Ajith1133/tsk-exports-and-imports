...
export default async function ProductDetail({ params }: PageProps) {
  ...
  return (
    <main style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      <a href="/products" style={{ display: 'inline-block', marginBottom: '2rem', color: '#1565c0' }}>
        ← Back to Products
      </a>
      ...
      <div style={{ display: 'flex', gap: '2rem', flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: '2', minWidth: '300px' }}>
          ...
          <div style={{ fontSize: '1.1rem', lineHeight: '1.6', marginTop: '16px', whiteSpace: 'pre-wrap' }}>
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', background: '#f1f5f9', borderRadius: '8px' }}>
            ...
            <a href="mailto:enquiry@tskexportsandimports.com" style={{ color: '#1565c0', fontSize: '1.1rem', fontWeight: 'bold' }}>
